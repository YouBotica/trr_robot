...
class SteeringActionClient(Node):
    ...
    def send_goal(self, angle):
        ...
        joint_names = ['T_joint', 'R1_joint', 'R2_joint']
    ...
    def feedback_callback(self, feedback_msg):
        ...
        self.actual_angles = [float(feedback.actual.positions[0]), float(feedback.actual.positions[1]), float(feedback.actual.positions[2])] 
